...
router.get('/manager/allPersonnel', [authJwt.verifyToken, authJwt.estAdmin], controller.allPersonnel);
router.get('/client/allPersonnelEmploye', [authJwt.verifyToken], controller.allPersonnelEmploye);
router.put('/manager/update_status', [authJwt.verifyToken, authJwt.estAdmin], controller.update_status);
router.post('/getUserById', [authJwt.verifyToken], controller.findUserById);
router.put('/employe/update_user', [authJwt.verifyToken, authJwt.estEmploye], controller.update_user);
router.post('/manager/filter_user', [authJwt.verifyToken, authJwt.estEmploye], controller.filterUser);
